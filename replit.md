...
-   **Back to Top Button**: Smooth-scrolling floating button that appears when users scroll down 300px or more, enabling quick navigation back to the top of the page. Features proper accessibility with aria-label and smooth scroll behavior.
