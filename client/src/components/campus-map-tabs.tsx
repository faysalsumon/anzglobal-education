...
export function CampusMapTabs({ 
  ...
  const createInfoWindowContent = useCallback((name: string, address: string): HTMLElement => {
    ...
    link.style.cssText = "display: inline-flex; align-items: center; gap: 4px; font-size: 12px; color: #1E2A5E; text-decoration: none; font-weight: 500;";
            ...
            if (result.results[0]) {
              ...
              const marker = new google.maps.Marker({
                ...
                icon: {
                  ...
                  fillColor: i === selectedIndex ? "#1E2A5E" : "#2DBDB6",
                  fillOpacity: 1,
                  strokeColor: "#ffffff",
                  strokeWeight: 3,
                },
  ...
  useEffect(() => {
    ...
    markersRef.current.forEach((marker, index) => {
      ...
      marker.setIcon({
        ...
        fillColor: isSelected ? "#1E2A5E" : "#2DBDB6",
        fillOpacity: 1,
        strokeColor: "#ffffff",
        strokeWeight: 3,
      });
