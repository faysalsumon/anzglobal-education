  ...
  footerSections: [
    {
      ...
      titleKey: "footer.explore",
      links: [
        { label: "Courses", href: "/courses", labelKey: "footer.links.courses" },
        { label: "Institutions", href: "/institutions", labelKey: "footer.links.institutions" },
        { label: "Study Abroad", href: "/study-abroad", labelKey: "footer.links.studyAbroad" },
        { label: "Blog", href: "/blog", labelKey: "footer.links.blog" },
      ],
    },
    {
      title: "Company",
      titleKey: "footer.company",
      links: [
        { label: "Our Story", href: "/our-story", labelKey: "footer.links.ourStory" },
        { label: "Student Reviews", href: "/student-reviews", labelKey: "footer.links.studentReviews" },
        { label: "Contact Us", href: "/contact", labelKey: "footer.links.contactUs" },
      ],
    },
    {
      title: "Legal",
      titleKey: "footer.legal",
      links: [
        { label: "Privacy Policy", href: "/privacy", labelKey: "footer.links.privacyPolicy" },
        { label: "Terms of Use", href: "/terms", labelKey: "footer.links.termsOfUse" },
      ],
    },
  ],
  pageVisibility: {
