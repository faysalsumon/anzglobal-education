...
import { TasksBoardPanel } from "@/components/tasks-board-panel";
      ...
      <div className="flex flex-col flex-1 min-w-0 h-full">
        ...
        <header className="flex-shrink-0 h-14 flex items-center gap-2 border-b bg-background px-4 md:px-6">
          ...
          {activeTab === "applications" ? (
            ...
            <div className="flex flex-col flex-1 min-h-0 overflow-hidden px-4 md:px-6 py-4 pb-16 lg:pb-4">
              <TasksBoardPanel />
            </div>
